...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.14.xcframework.zip",
			checksum: "9d932ebd9c41dfbdbb4bd04b19bc9e9d4db34455f1a190fb4f65fa4d34b4eed4"
		)
	]
)