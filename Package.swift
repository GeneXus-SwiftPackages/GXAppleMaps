...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-2.0.0-rc.36.xcframework.zip",
			checksum: "697017be5c4b98a8e5a87ca5b179511a9574fc2a067b4aa2da1c7cdabf5578c9"
		)
	]
)