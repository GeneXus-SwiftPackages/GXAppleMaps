...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.2.0-rc.36.xcframework.zip",
			checksum: "132eda3a16a4e3d64c1502ff88bc8567063f0443bf07e55d602436e0b79d38aa"
		)
	]
)