...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-4.2.0-beta.32.xcframework.zip",
			checksum: "daf73052b635e6ee166e72c013e0469181f4d2da11a865e8a9328a45e6e8724f"
		)
	]
)