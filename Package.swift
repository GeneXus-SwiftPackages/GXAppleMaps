...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-4.2.0-beta.30.xcframework.zip",
			checksum: "b450b57f18c70fd83b20150a19866be90b020e5d7e71096e40e3cf775c26adef"
		)
	]
)