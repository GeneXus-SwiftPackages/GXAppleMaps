...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-3.2.0-rc.0.xcframework.zip",
			checksum: "3635337f669a46ec6c6c289fe186580ba1323e185fb62d5d3d540fc2ea0544b6"
		)
	]
)