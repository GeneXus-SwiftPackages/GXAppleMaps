...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.28.xcframework.zip",
			checksum: "a0bc94ce948efe94b01bf32d6e286ddc99221c01b9d7a5f0aabcf4198dd7aec7"
		)
	]
)