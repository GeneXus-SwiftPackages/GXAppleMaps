...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.2.0-rc.29.xcframework.zip",
			checksum: "cbdfa7eb0579786150cfce78893c870d08319de8fa8e32ab6d7461fbcd80a38f"
		)
	]
)