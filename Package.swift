...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.0.0-beta.16.xcframework.zip",
			checksum: "51870bef80de486007d0fbb4d96484cd4db66b8c91b46c43fab452942d48d85f"
		)
	]
)