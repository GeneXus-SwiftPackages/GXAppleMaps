...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.1.0-beta.23.xcframework.zip",
			checksum: "c77ceb90378ce9e10f90e10eae41958a1186f2c2d2e954e65eb29e391716d634"
		)
	]
)