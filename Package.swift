...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.4.0-beta.11.xcframework.zip",
			checksum: "e005afab8286f1b202efe40360586f28790f92ccf0eb0ef0dcdb7d815369c4af"
		)
	]
)