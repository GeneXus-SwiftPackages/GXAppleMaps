...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-2.0.0-rc.32.xcframework.zip",
			checksum: "2a041bbfa48fc5b627ff15989a9dd48df04ecd1d2d90375555ef9c5f7bbb7043"
		)
	]
)