...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.21.xcframework.zip",
			checksum: "64c81a9fcd50b447daefc5e6fc14f6a305e6cd030afe5d8467751a0c8ff5deff"
		)
	]
)