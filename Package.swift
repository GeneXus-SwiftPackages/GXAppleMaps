...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.0.0-beta+20230302113401.xcframework.zip",
			checksum: "de7e407d8c3946919533c82dbacfb4fa6aae303e11a4f6cd52c0b26a9f65fcb2"
		)
	]
)