...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.23.xcframework.zip",
			checksum: "bebddb9c439724542e8d247fc1be8064ca8325fd8dbed803423f5f1b5ac02915"
		)
	]
)