...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.22.xcframework.zip",
			checksum: "7cfda38febed5661ec11457e98390d24bc1cdf44e36dfae243497b5acdcfdf02"
		)
	]
)