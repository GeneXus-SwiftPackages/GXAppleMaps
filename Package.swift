...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.1.0-rc.5.xcframework.zip",
			checksum: "e529134642772c92b6cc188f0a1d7bb808e117e7d010d86d2424d3cfbacea67b"
		)
	]
)