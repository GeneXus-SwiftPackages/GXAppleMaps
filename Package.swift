...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.33.xcframework.zip",
			checksum: "609daefa7067f598e1faec2997586615666ef1fc5af5fe1fa811da83204e96ff"
		)
	]
)