...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.10.xcframework.zip",
			checksum: "d2fdc42c214e3c0bcc59def22662c25449fcadb8d142ed604fa1964a3b47b608"
		)
	]
)