...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.0.0-beta+20230309092859.xcframework.zip",
			checksum: "9c9d1cef1920a9d47b92cabe096189900423d70c45803481d0508050f61ec75a"
		)
	]
)