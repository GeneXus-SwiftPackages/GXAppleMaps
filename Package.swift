...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.5.0-beta.17.xcframework.zip",
			checksum: "fe1cd2ad195d37c154c675fdf31570445592f038cb02ee000a04de5765422ae1"
		)
	]
)