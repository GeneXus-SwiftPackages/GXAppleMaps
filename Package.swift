...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-2.2.0-rc.3.xcframework.zip",
			checksum: "4384ceeb8faadd29c4819fce2c440f0f2c7b0db735b0ee37c1e85476e100c6a3"
		)
	]
)