...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.3.0-rc.1.xcframework.zip",
			checksum: "6a39b7ff303bf0a4599459628842deb2df8b6d14f9234656bd8b1eb6dea6bd77"
		)
	]
)