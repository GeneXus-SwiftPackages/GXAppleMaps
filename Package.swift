...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.5.0-beta.16.xcframework.zip",
			checksum: "0ac48217f49ebea21c566d312778db8456c46893a8cb4429adad366b565a9557"
		)
	]
)