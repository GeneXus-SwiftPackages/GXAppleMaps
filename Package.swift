...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.2.0-beta.27.xcframework.zip",
			checksum: "a76a3724c25c6735a9da3fe122cc9b40f6c56bb89dfe58b4aebed91950f3d706"
		)
	]
)