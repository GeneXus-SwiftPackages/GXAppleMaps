...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.18.xcframework.zip",
			checksum: "e7bcd11b5d2c969324574afcfe07defb44463d771c54493c2c1f36d3bcf5623f"
		)
	]
)