...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.3.0-rc.13.xcframework.zip",
			checksum: "46a056167b93f4929ce4a1733b5fbb230cc4e8c53346bcac0b79ae52f7cf4bce"
		)
	]
)