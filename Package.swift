...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.12.xcframework.zip",
			checksum: "0e9c63c2584d0241279f938ea22af16b4c09f2e0ce481bcdec18a8e903c3ef65"
		)
	]
)