...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.5.0-beta.28.xcframework.zip",
			checksum: "58107b71e691865bcf19314ffe5de85aef8d73bcf7f0649d78b240744dac3f2f"
		)
	]
)