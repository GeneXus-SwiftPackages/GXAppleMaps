...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-4.0.0-beta.49.xcframework.zip",
			checksum: "c89180f9a0c2ad0265188a7217714f37e2dd2410e701260d4f0a1a5447945c4d"
		)
	]
)