...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.1.0-beta.16.xcframework.zip",
			checksum: "61fbe552468166377fa901066539d75fdc6bb8547b9de64539f9b9921b4bbd5b"
		)
	]
)