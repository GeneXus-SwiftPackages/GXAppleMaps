...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.4.0-rc.10.xcframework.zip",
			checksum: "92b5fc65535fbe94b2c5e80a14c063f151e577b9f878228f2bc59492d35aab8a"
		)
	]
)