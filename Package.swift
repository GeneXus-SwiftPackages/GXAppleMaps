...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.0.0-beta+20230418130717.xcframework.zip",
			checksum: "2461c9709587bbdd645662df6333437536b84be46f62d3c8b87e228e386c055f"
		)
	]
)