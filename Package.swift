...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.3.0-beta.11.xcframework.zip",
			checksum: "897830f6bb0114a686ef85e9d4760d989e615e8350015ae876a6ac59a1c9c023"
		)
	]
)