...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.18.xcframework.zip",
			checksum: "a78f3047010806e3c171811dca6f29271f48b86accb2f0b1b4338aea1c91c053"
		)
	]
)