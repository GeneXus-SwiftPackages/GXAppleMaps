...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.1.0-beta.27.xcframework.zip",
			checksum: "68096146e086ab29e7d9b1c980b10af36d77d1be26bc58a6c89e40ff356b93b2"
		)
	]
)