...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.36.xcframework.zip",
			checksum: "73ab5a8bedd35ba685693f9a4e463fe87bd7f20040d4c07e15574f0e388a6146"
		)
	]
)