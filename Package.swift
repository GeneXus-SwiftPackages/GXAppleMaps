...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.4.0-beta.16.xcframework.zip",
			checksum: "bd35ff515a7256915f1a3423fbc949df10a00f74223fa93fc65a9a9bb9c7dd5f"
		)
	]
)