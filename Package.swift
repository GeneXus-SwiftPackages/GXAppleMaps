...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.2.0-rc.25.xcframework.zip",
			checksum: "0f400ac28fc4872c359b0f441012dff6e1867838a25717a50899f0a35712636d"
		)
	]
)