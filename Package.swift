...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.2.0-beta.11.xcframework.zip",
			checksum: "bf19bfb30854b02aa7578dce3f339e085f56583f28bcb6b8332ebfcb27c2243b"
		)
	]
)