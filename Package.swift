...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.0.0-beta.10.xcframework.zip",
			checksum: "86dbe0e8b083d2514534835a8aef8e5a03e5f1c573caef1e883c6349bc02598c"
		)
	]
)