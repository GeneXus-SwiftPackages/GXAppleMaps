...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.26.xcframework.zip",
			checksum: "60ab0c939dfabbcf1c32031608854124439fb8f299a8cf6a7267c047672a98dd"
		)
	]
)