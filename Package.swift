...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.17.xcframework.zip",
			checksum: "828fe4fff092fcbb84a9c2b8011bc92eeaeb81b72632eb79bed12a4ba0e9b9e7"
		)
	]
)