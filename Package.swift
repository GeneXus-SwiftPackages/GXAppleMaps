...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.4.0-beta.20.xcframework.zip",
			checksum: "06633e7d2804908f86e56feb674f2afc946546514df36dac0b20355915145bdd"
		)
	]
)