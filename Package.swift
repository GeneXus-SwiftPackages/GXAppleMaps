...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.11.xcframework.zip",
			checksum: "45fd38435c48b6bb310b725ab18250c6e3100d62e4e9e3bf7da3e3022b24e09b"
		)
	]
)