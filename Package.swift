...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.1.0-beta.17.xcframework.zip",
			checksum: "0873f46af44634ae18290791c9b10fbe6d957f4baa75f31f320f399c710ba898"
		)
	]
)