...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.22.xcframework.zip",
			checksum: "d88328a25bdac42a7e89d10b61646a968fa69c37db75257761977a899b40e436"
		)
	]
)