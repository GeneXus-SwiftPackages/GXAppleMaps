...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.25.xcframework.zip",
			checksum: "0f64a0a6108793aa196347b743cace46e0f3beff3cb42a8da95fbb8c41ac5c7e"
		)
	]
)