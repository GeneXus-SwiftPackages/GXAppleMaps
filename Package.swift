...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "a45412185fac60febb7c6664deac7149f3f50a3037e0c5a4a787dc8093755cfe"
		)
	]
)