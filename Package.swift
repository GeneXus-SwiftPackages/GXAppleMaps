...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.5.0-beta.26.xcframework.zip",
			checksum: "5a99041c98370335d5f1b21bef48a187ffee5327ea8c46b056f737a1ded167e9"
		)
	]
)