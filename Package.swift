...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.6.0-rc.0.xcframework.zip",
			checksum: "eb8b95b89c5815496071fbd489ecb085de67e32bafb7dcf8238932cdb44ecdc5"
		)
	]
)