...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.4.0-rc.21.xcframework.zip",
			checksum: "29946b619b76b9a587b4112c6500d3ae8511e574ee7c2e5c3c1044622fb94ee9"
		)
	]
)