...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-2.2.0-rc.1.xcframework.zip",
			checksum: "2f9a828af3a84baf176cffa994b1806966437dc36c9665b7e2728df5f6e5ae5a"
		)
	]
)