...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.0.0-beta.35.xcframework.zip",
			checksum: "cba97d9c7f504cae5dfa2c9cfded9dd8f7b6d09a821b9d7a01b2ed002a9b896a"
		)
	]
)