...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.10.xcframework.zip",
			checksum: "9a0547664e711522845dd900cdc111dff38cb9e0effa541df94db9cace73a23f"
		)
	]
)