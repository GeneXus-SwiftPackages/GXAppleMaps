...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-2.0.0-rc.34.xcframework.zip",
			checksum: "ef450515392e394fa558d1b491631ae9ebb16b8b1320263cb263f49fca45801c"
		)
	]
)