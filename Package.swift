...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.4.0-beta.12.xcframework.zip",
			checksum: "aa33596fe807ee0378846c7a67b773a0778f06a67f60dc7d38b70afdf3e401ca"
		)
	]
)