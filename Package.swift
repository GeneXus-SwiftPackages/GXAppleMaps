...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAppleMaps-1.4.0-rc.5.xcframework.zip",
			checksum: "92e0f9636e8882fe256cb43e364c9d48aa362e5fb1248ac5a3798fc1b2dd971a"
		)
	]
)