...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.31.xcframework.zip",
			checksum: "292125292676231140e3061f5d090adad7954c4fdb1a7d03c82ae92a0586fb0a"
		)
	]
)