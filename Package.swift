...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.5.0-beta.13.xcframework.zip",
			checksum: "c40d31772ce0d3ab444a1f5ff672fdc7763b50028de772343aea9bfea9d18109"
		)
	]
)