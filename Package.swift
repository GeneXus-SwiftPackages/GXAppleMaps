...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.1.0-beta.19.xcframework.zip",
			checksum: "9d4aa1cc1a36b96fd7bf4a3fcf54a181864b7b7dc69c189a650343e672445c8e"
		)
	]
)