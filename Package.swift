...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-3.0.0-beta.17.xcframework.zip",
			checksum: "434c1bded2935105658621726d0c802f29c0c4fb873fb650e09b33700809d3b0"
		)
	]
)