...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-2.2.0-beta.26.xcframework.zip",
			checksum: "4f3a552fc3995383a1d763d4c7cd72e9319afe0e0fd421f0cc4f5aa5e90cf050"
		)
	]
)