...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.2.0-beta.30.xcframework.zip",
			checksum: "92e0df3de694aa0a7681575583f31840494c1a5e3a76fcb88d9cf0d8d38cc542"
		)
	]
)