...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAppleMaps",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAppleMaps-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "123443cfbe966811d5504f12603c55ce2ff242e71d1d0e306309da2cad2233e8"
		)
	]
)